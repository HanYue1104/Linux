...
```shell
#在经过多次尝试，跑带修饰的MD的时候是需要把residuetypes.dat放到MD的工作目录中的
gmx_mpi pdb2gmx -f enok343hib_finall.pdb -o enok343hib_finall.gro -water spc -ignh -ter
#这里遇到报错，就发现PDB结构有关。
#然后将我的PDB结构用pymol打开另存了一下，再操作就可以使用了。有可能是之前那个蛋白用的是chimera另存的并不是完全识别。
gmx_mpi editconf -f 2pg_Unit_finall.pdb -o 2pg_Unit_finall.gro
合并gro文件enok343hib_2pg.gro
拓扑文件添加信息
; Include ligand topology
#include "2pgunit_finall.itp"
5YHW                1

#从这里就需要把小分子的力场加到拓扑文件中了。
gmx_mpi editconf -f enok343hib_2pg.gro -o newbox.gro -bt cubic -d 1.0
...
gmx_mpi genion -s ions.tpr -o solv_ions.gro -p topol.top -pname NA -nname CL -np 2
>14 SOL
gmx_mpi grompp -f em.mdp -c solv_ions.gro -p topol.top -o em.tpr -maxwarn 1
gmx_mpi mdrun -v -deffnm em
gmx_mpi energy -f em.edr -o em10.xvg

gmx_mpi make_ndx -f 2pg_Unit_finall.gro  -o index_lig.ndx
...
 > 0 & ! a H*
 > q
gmx_mpi genrestr -f 2pg_Unit_finall.gro -n index_lig.ndx -o posre_2pg.itp -fc 1000 1000 1000
 >3  #选3
 修改top文件
 
 ; Ligand position restraints
#ifdef POSRES_LIG
#include "posre_2pg.itp"
#endif
...
#MD_enokhib3做到这里了 20211229 16：50
gmx_mpi grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -n index.ndx -o nvt.tpr -maxwarn 1
gmx_mpi mdrun -v -deffnm nvt

gmx_mpi grompp -f npt.mdp -c nvt.gro -t nvt.cpt -r nvt.gro -p topol.top -n index.ndx -o npt.tpr -maxwarn 1
gmx_mpi mdrun -v -deffnm npt

gmx_mpi grompp -f md.mdp -c npt.gro -t npt.cpt -p topol.top  -o md_0_10.tpr -maxwarn 1
...
```shell
 2001  source /home/tmu/software/Downloads/gromacs-2019.6/bin/GMXRC
 2002  source /home/tmu/software/Downloads/gromacs_mpi/gromacs-2019.6/bin/GMXRC
 2003  gmx_mpi 
 2004  ls
 2005  gmx_mpi editconf -f 2pg_unit_finall_1.pdb -o 2pg.gro
 2006  touch eno2_2pg.gro
 2007  ls
 2008  gmx_mpi editconf -f 2pg_unit_finall_1.pdb -o 2pg.gro
 2009  gmx_mpi pdb2gmx -f eno2_1.pdb -o eno2_1.gro -water spc -ignh -ter
 2010  touch eno2_2pg.gro
 2011  ls
 2012  gmx_mpi editconf -f eno2_2pg.gro -o newbox.gro -bt cubic -d 1.0
 2013  gmx_mpi solvate -cp newbox.gro -cs spc216.gro -p topol.top -o solv.gro
 2014  vmd solv.gro 
 2015  gmx_mpi grompp -f ions.mdp -c solv.gro -p topol.top -o ions.tpr -maxwarn 1
 2016  gmx_mpi genion -s ions.tpr -o solv_ions.gro -p topol.top -pname NA -nname CL -np 1
 2017  gmx_mpi grompp -f em.mdp -c solv_ions.gro -p topol.top -o em.tpr -maxwarn 1
 2018  gmx_mpi mdrun -v -deffnm em
 2019  gmx_mpi energy -f em.edr -o em10.xvg
 2020  xmgrace em10.xvg 
 2021  gmx_mpi make_ndx -f 2pg.gro -o index_lig.ndx
 2022  gmx_mpi genrestr -f 2pg.gro -n index_lig.ndx -o posre_2pg.itp -fc 1000 1000 1000
 2023  gmx_mpi make_ndx -f em.gro -o index.ndx
 2024  gmx_mpi grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -n index.ndx -o nvt.tpr -maxwarn 1
 2025  gmx_mpi mdrun -v -deffnm nvt
 2026  history
...
gmx_mpi grompp -f md.mdp -c npt.gro -t npt.cpt -p topol.top -n index.ndx -o md_0_10.tpr -maxwarn 1
gmx_mpi mdrun -v -deffnm md_0_10
```
